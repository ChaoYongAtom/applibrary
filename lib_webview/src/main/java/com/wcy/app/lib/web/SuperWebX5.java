...
import com.wcy.app.lib.web.client.DefaultChromeClient;
import com.wcy.app.lib.web.client.DefaultWebClient;
import com.wcy.app.lib.web.client.DefaultWebCreator;
import com.wcy.app.lib.web.client.DefaultWebLifeCycleImpl;
import com.wcy.app.lib.web.client.MiddleWareWebChromeBase;
import com.wcy.app.lib.web.client.MiddleWareWebClientBase;
import com.wcy.app.lib.web.client.WebDefaultSettingsManager;
import com.wcy.app.lib.web.client.WebLifeCycle;
import com.wcy.app.lib.web.client.WebListenerManager;
import com.wcy.app.lib.web.client.WebSecurityCheckLogic;
import com.wcy.app.lib.web.client.WebSecurityController;
import com.wcy.app.lib.web.client.WebSecurityControllerImpl;
import com.wcy.app.lib.web.client.WebSecurityLogicImpl;
import com.wcy.app.lib.web.client.WebSettings;
import com.wcy.app.lib.web.client.WebViewClientCallbackManager;
import com.wcy.app.lib.web.file.DefaultDownLoaderImpl;
import com.wcy.app.lib.web.file.DownLoadResultListener;
import com.wcy.app.lib.web.file.IFileUploadChooser;
import com.wcy.app.lib.web.js.JsEntraceAccess;
import com.wcy.app.lib.web.js.JsEntraceAccessImpl;
import com.wcy.app.lib.web.js.JsInterfaceHolder;
import com.wcy.app.lib.web.js.JsInterfaceHolderImpl;
import com.wcy.app.lib.web.progress.BaseIndicatorView;
import com.wcy.app.lib.web.progress.IndicatorController;
import com.wcy.app.lib.web.progress.IndicatorHandler;
import com.wcy.app.lib.web.progress.WebCreator;
...
import com.wcy.app.lib.web.video.EventHandlerImpl;
import com.wcy.app.lib.web.video.EventInterceptor;
import com.wcy.app.lib.web.video.IEventHandler;
import com.wcy.app.lib.web.video.IVideo;
import com.wcy.app.lib.web.video.VideoImpl;
...
public class SuperWebX5 {
    ...
    private void init() {
        if (this.mDownloadListener == null) mDefaultMsgConfig = new DefaultMsgConfig();
        doCompat();
        doSafeCheck();
    }
    ...
    private WebCreator configWebCreator(BaseIndicatorView progressView, int index, ViewGroup.LayoutParams lp, int mIndicatorColor, int height_dp, WebView webView, IWebLayout webLayout) {
        ...
        if (progressView != null && enableProgress) {
            ...
            return enableProgress ? new DefaultWebCreator(mActivity, mViewGroup, lp, index, mIndicatorColor, height_dp, webView, webLayout) : new DefaultWebCreator(mActivity, mViewGroup, lp, index, webView, webLayout);
        }
    }
    ...
    public static SuperBuilder with(@NonNull Activity activity) {
        if (activity == null) throw new NullPointerException("activity can not null");
    ...
    private EventInterceptor getInterceptor() {
        ...
        if (this.mEventInterceptor != null) return this.mEventInterceptor;
    ...
    private void setDownloadListener(List<DownLoadResultListener> downLoadResultListeners, boolean isParallelDl, int icon) {
        ...
        if (mDownloadListener == null) {
            this.mDownloadListener = mDownloadListener = new DefaultDownLoaderImpl.Builder().setActivity(mActivity).setEnableIndicator(true)//
                    .setForce(false)//
                    ...
                    .setPermissionInterceptor(this.mPermissionInterceptor).setIcon(icon).create();
    ...
    private WebChromeClient getChromeClient() {
        ...
        DefaultChromeClient mDefaultChromeClient = new DefaultChromeClient(this.mActivity, this.mIndicatorController = mIndicatorController, this.mWebChromeClient, this.mChromeClientCallbackManager, this.mIVideo = getIVideo(), mDefaultMsgConfig.getChromeClientMsgCfg(), this.mPermissionInterceptor, mWebCreator.get());
    ...
    public void uploadFileResult(int requestCode, int resultCode, Intent data) {
        ...
        if (mIFileUploadChooser == null) mIFileUploadChooser = mSuperWebJsInterfaceCompat.pop();
        ...
        if (mIFileUploadChooser != null) mIFileUploadChooser = null;
    }
    ...
    public static class SuperBuilder {
        ...
        private void addJavaObject(String key, Object o) {
            if (mJavaObject == null) mJavaObject = new ArrayMap<>();
...
//                throw new IllegalStateException(" please call ready before go  to finish all webview settings");  //i want to do this , but i cannot;
    ...
    public static final class SuperBuilderFragment {
        ...
        private void addHeader(String k, String v) {
            ...
            if (additionalHttpHeaders == null) additionalHttpHeaders = new ArrayMap<>();
    ...
    public static SuperWebX5 create(Fragment fragment, View view, ViewGroup.LayoutParams lp, ChromeClientCallbackManager.ReceivedTitleCallback mCallback, String url) {
        ...
        SuperWebX5 mSuperWebX5 = SuperWebX5.with(fragment).setSuperWebParent((ViewGroup) view, lp).
                ...
                interceptUnkownScheme().openParallelDownload().
                setSecurityType(SuperWebX5.SecurityType.strict).
                createSuperWeb().ready().go(url);
        return mSuperWebX5;
    }
