...
public class MaterialWaveView extends View implements MaterialHeadListener {
    ...
    public void onPull(MaterialRefreshLayout br, float fraction) {
        setHeadHeight((int) (ForPxTp.dip2px(getContext(), DefaulHeadHeight) * ForPxTp.limitValue(1, fraction)));
        setWaveHeight((int) (ForPxTp.dip2px(getContext(), DefaulWaveHeight) * Math.max(0, fraction - 1)));
        invalidate();
    }
    ...
    public void onRefreshing(MaterialRefreshLayout br) {
        setHeadHeight((int) (ForPxTp.dip2px(getContext(), DefaulHeadHeight)));
